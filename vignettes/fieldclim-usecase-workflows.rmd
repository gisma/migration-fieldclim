...
Die Vorlesungsfolien verwenden für die bodennahe Energiebilanz die Größen `Q*`, `B`, `L` und `V`. Diese Vignette behält diese Notation im Erklärungsteil bei. Erst an der Schnittstelle zum Datensatz und zu `fieldClim` wird auf Paket- und Spaltennamen gemappt.

```{r theory-energy-figures, echo=FALSE, fig.width=8, fig.height=4.5, out.width="100%"}
knitr::include_graphics(c(
  "figures/mesoklima_p45.png",
  "figures/mesoklima_p46.png"
))
```
...
knitr::include_graphics(c(
  "figures/mesoklima_p18.png",
  "figures/mesoklima_p20.png",
  "figures/mesoklima_p33.png",
  "figures/mesoklima_p34.png"
))
```
...
knitr::include_graphics(c(
  "figures/mesoklima_p39.png",
  "figures/mesoklima_p41.png"
))
```
...
knitr::include_graphics(c(
  "figures/mesoklima_p47.png",
  "figures/mesoklima_p50.png"
))
```
...
Die vorhandenen Wärmeflussvignetten und Hilfeseiten zeigen mehrere methodische Familien. Diese Vignette führt sie auf derselben Datenbasis zusammen.
